...
The following questions and tasks are addressed in our exploratory analysis. For each question/task we need to make a single plot. Unless specified, we can use any plotting system in R to make your plot.
